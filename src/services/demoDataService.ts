...
const demoUsers: User[] = [
    ...initialUsers,
    { id: 'teacher-2', name: 'Carlos Gomez (Tutor)', email: 'carlos.gomez@managerpro.edu', password: 'password', avatar: 'https://i.pravatar.cc/150?u=teacher-2', profiles: [Profile.TEACHER], activity_status: 'Activo', location_status: 'En el centro', contract_type: 'Fijo', role_type: 'Titular', phone: '622334455', address: 'Plaza Mayor 1', work_area: 'Servicios' },
    { id: 'teacher-3', name: 'Lucia Fernandez (Sustituta)', email: 'lucia.fernandez@managerpro.edu', password: 'password', avatar: 'https://i.pravatar.cc/150?u=teacher-3', profiles: [Profile.TEACHER], activity_status: 'Activo', location_status: 'Fuera del centro', contract_type: 'Interino', role_type: 'Sustituto', phone: '633445566', address: 'Camino Nuevo 8', work_area: 'Panadería' },
