                ...
                <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                        <button 
                            ...
                            className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2.5 rounded-xl flex items-center space-x-2 shadow-lg shadow-primary-500/20 transition-all font-black uppercase tracking-widest text-xs"
                        >
